...
export class UViewCompletionItemProvider implements CompletionItemProvider<CompletionItem> {
  ...
  getAttrValues(tag: string, attr: string): string[] {
    ...
    const document: Record<string, any> = localDocument[version]
